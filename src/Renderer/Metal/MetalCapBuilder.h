...
#define CAN_COLOR_WRITE(x) pRenderer->canColorWriteTo[TinyImageFormat_##x] = true;
	...
	if( [pRenderer->pDevice supportsFeatureSet: MTLFeatureSet_macOS_GPUFamily1_v1]) {
		...
		CAN_SHADER_READ(A8B8G8R8_UNORM_PACK32);
		CAN_SHADER_READ(A8B8G8R8_SNORM_PACK32);
		CAN_SHADER_READ(A8B8G8R8_SRGB_PACK32);
		CAN_SHADER_READ(A8R8G8B8_UNORM_PACK32);
		CAN_SHADER_READ(A2R10G10B10_UNORM_PACK32);
		CAN_SHADER_READ(A2B10G10R10_UNORM_PACK32);
		CAN_SHADER_READ(B10G11R11_UFLOAT_PACK32);
		CAN_SHADER_READ(E5B9G9R9_UFLOAT_PACK32);
		...
		CAN_COLOR_WRITE(A8B8G8R8_UNORM_PACK32);
		CAN_COLOR_WRITE(A8B8G8R8_SNORM_PACK32);
		CAN_COLOR_WRITE(A8B8G8R8_SRGB_PACK32);
		CAN_COLOR_WRITE(A8R8G8B8_UNORM_PACK32);
		CAN_COLOR_WRITE(A2R10G10B10_UNORM_PACK32);
		CAN_COLOR_WRITE(A2B10G10R10_UNORM_PACK32);
		CAN_COLOR_WRITE(B10G11R11_UFLOAT_PACK32);
		...
		CAN_SHADER_READ(BC1_RGB_UNORM_BLOCK);
		CAN_SHADER_READ(BC1_RGB_SRGB_BLOCK);
		CAN_SHADER_READ(BC1_RGBA_UNORM_BLOCK);
		CAN_SHADER_READ(BC1_RGBA_SRGB_BLOCK);
		CAN_SHADER_READ(BC2_UNORM_BLOCK);
		CAN_SHADER_READ(BC2_SRGB_BLOCK);
		CAN_SHADER_READ(BC3_UNORM_BLOCK);
		CAN_SHADER_READ(BC3_SRGB_BLOCK);
		CAN_SHADER_READ(BC4_UNORM_BLOCK);
		CAN_SHADER_READ(BC4_SNORM_BLOCK);
		CAN_SHADER_READ(BC5_UNORM_BLOCK);
		CAN_SHADER_READ(BC5_SNORM_BLOCK);
		CAN_SHADER_READ(BC6H_UFLOAT_BLOCK);
		CAN_SHADER_READ(BC6H_SFLOAT_BLOCK);
		CAN_SHADER_READ(BC7_UNORM_BLOCK);
		CAN_SHADER_READ(BC7_SRGB_BLOCK);
		...
		CAN_SHADER_READ(R8_USCALED);
		CAN_SHADER_READ(R8_SSCALED);
		CAN_SHADER_READ(R8_UINT);
		CAN_SHADER_READ(R8_SINT);
		CAN_SHADER_READ(R8G8_USCALED);
		CAN_SHADER_READ(R8G8_SSCALED);
		CAN_SHADER_READ(R8G8_UINT);
		CAN_SHADER_READ(R8G8_SINT);
		CAN_SHADER_READ(R16_USCALED);
		CAN_SHADER_READ(R16_SSCALED);
		CAN_SHADER_READ(R16_UINT);
		CAN_SHADER_READ(R16_SINT);
		CAN_SHADER_READ(R8G8B8A8_USCALED);
		CAN_SHADER_READ(R8G8B8A8_SSCALED);
		CAN_SHADER_READ(R8G8B8A8_UINT);
		CAN_SHADER_READ(R8G8B8A8_SINT);
		CAN_SHADER_READ(R16G16_USCALED);
		CAN_SHADER_READ(R16G16_SSCALED);
		CAN_SHADER_READ(R16G16_UINT);
		CAN_SHADER_READ(R16G16_SINT);
		CAN_SHADER_READ(R32_UINT);
		CAN_SHADER_READ(R32_SINT);
		CAN_SHADER_READ(A8B8G8R8_USCALED_PACK32);
		CAN_SHADER_READ(A8B8G8R8_SSCALED_PACK32);
		CAN_SHADER_READ(A8B8G8R8_UINT_PACK32);
		CAN_SHADER_READ(A8B8G8R8_SINT_PACK32);
		CAN_SHADER_READ(A2B10G10R10_USCALED_PACK32);
		CAN_SHADER_READ(A2B10G10R10_UINT_PACK32);
		CAN_SHADER_READ(R16G16B16A16_USCALED);
		CAN_SHADER_READ(R16G16B16A16_SSCALED);
